...
export function HistogramSection({ histogram, logCount, isLoading }: HistogramSectionProps) {
    return (
        <section className="animate-fade-in-up">
            <div className="flex items-center justify-between mb-4">
                <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest">Log Distribution</h2>
                <span className="text-xs text-gray-500 font-mono">Count: {logCount} logs</span>
            </div>
