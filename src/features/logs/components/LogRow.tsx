  ...
  return (
    <div ref={measureRef} data-testid="log-row" data-index={virtualIndex}>
      <div
        ...
        className="group grid grid-cols-[1fr_8fr] md:grid-cols-[140px_120px_150px_1fr] lg:grid-cols-[150px_150px_180px_1fr] gap-4 p-3 border-b border-gray-800/60 hover:bg-gray-800/40 cursor-pointer transition-colors items-start"
      >
        <div className="flex items-center gap-2">
          ...
          <span
            className={twMerge(
              "text-xs px-2 py-0.5 rounded border uppercase font-medium tracking-wide flex items-center gap-1.5",
              styles.badge,
            )}
          >
        ...
        <div className="text-gray-400 text-sm font-mono self-center hidden md:block truncate">
          {log.serviceName}
        </div>
        <div className="text-gray-400 text-sm font-mono self-center hidden md:block">
          {timeStr}
        </div>
